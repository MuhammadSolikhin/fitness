...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/homepage/css/bootstrap.min.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ asset('assets/homepage/css/font-awesome.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/homepage/css/templatemo-training-studio.css') }}">
    <style>
        .wa-floating {
            position: fixed;
            width: 60px;
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.html" class="logo"><img src="{{ asset('assets/Foto/Logo Kurnia.png') }}" alt=""
                                srcset=""
                                style="opacity: .8; width: 100%; height: auto; max-height: 70px; object-fit: contain;"></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
    ...
    <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="{{ asset('assets/homepage/images/gym-video.mp4') }}" type="video/mp4" />
        </video>

        <div class="video-overlay header-text">
            <div class="caption">
                <h6>work harder, get stronger</h6>
                <h2>easy with our <em>Class</em></h2>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="{{ asset('assets/homepage/images/line-dec.png') }}" alt="waves">
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="{{ asset('assets/homepage/images/features-first-icon.png') }}"
                                    alt="First One">
                            </div>
    ...
    <section class="section" id="our-classes">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="{{ asset('assets/homepage/images/line-dec.png') }}" alt="">
            ...
            <div class="row" id="tabs">
                <div class="col-lg-4">
                    <ul>
                        <li><a href='#tabs-1'><img src="{{ asset('assets/homepage/images/tabs-first-icon.png') }}"
                                    alt="">First Training Class</a></li>
                        <li><a href='#tabs-2'><img src="{{ asset('assets/homepage/images/tabs-first-icon.png') }}"
                                    alt="">Second Training Class</a></a></li>
                        <li><a href='#tabs-3'><img src="{{ asset('assets/homepage/images/tabs-first-icon.png') }}"
                                    alt="">Third Training Class</a></a></li>
                        <li><a href='#tabs-4'><img src="{{ asset('assets/homepage/images/tabs-first-icon.png') }}"
                ...
                <div class="col-lg-8">
                    <section class='tabs-content'>
                        <article id='tabs-1'>
                            <img src="{{ asset('assets/homepage/images/training-image-01.jpg') }}" alt="First Class">
                        ...
                        <article id='tabs-2'>
                            <img src="{{ asset('assets/homepage/images/training-image-02.jpg') }}"
                                alt="Second Training">
                        ...
                        <article id='tabs-3'>
                            <img src="{{ asset('assets/homepage/images/training-image-03.jpg') }}" alt="Third Class">
                        ...
                        <article id='tabs-4'>
                            <img src="{{ asset('assets/homepage/images/training-image-04.jpg') }}"
                                alt="Fourth Training">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ asset('assets/homepage/images/first-trainer.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ asset('assets/homepage/images/second-trainer.jpg') }}" alt="">
                        </div>
                        <div class="down-content">
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="{{ asset('assets/homepage/images/third-trainer.jpg') }}" alt="">
                        </div>
                        <div class="down-content">
                    ...
                    <div id="map">
                        <div class="embed-map-responsive">
                            <div class="embed-map-container"><iframe class="embed-map-frame" frameborder="0"
                                    ...
                                    src="https://maps.google.com/maps?width=600&height=500&hl=en&q=unpam%20viktor&t=&z=15&ie=UTF8&iwloc=B&output=embed"></iframe><a
    ...
    <a href="https://wa.me/6281297159212?text=Halo%20saya%20ingin%20bertanya%20tentang%20layanan%20Anda"
        class="wa-floating" target="_blank">
        <img src="https://img.icons8.com/color/48/000000/whatsapp.png" alt="WhatsApp" />
    </a>

    <!-- jQuery -->
    <script src="{{ asset('assets/homepage/js/jquery-2.1.0.min.js') }}"></script>

    <!-- Bootstrap -->
    <script src="{{ asset('assets/homepage/js/popper.js') }}"></script>
    <script src="{{ asset('assets/homepage/js/bootstrap.min.js') }}"></script>

    <!-- Plugins -->
    <script src="{{ asset('assets/homepage/js/scrollreveal.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/homepage/js/imgfix.min.js') }}"></script>
    <script src="{{ asset('assets/homepage/js/mixitup.js') }}"></script>
    <script src="{{ asset('assets/homepage/js/accordions.js') }}"></script>
